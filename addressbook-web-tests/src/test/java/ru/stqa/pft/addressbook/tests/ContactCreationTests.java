...
public class ContactCreationTests {
    ...
    public void testContactCreation() {
        ...
        initContactCreation();
        fillContactForm(new ContactData("test_first_name", "test_last_name", "test_address", "123456", "test_first_name.test_last_name@ya.ru"));
    ...
    private void fillContactForm(ContactData contactData) {
        ...
        wd.findElement(By.name("email")).sendKeys(contactData.getE_mail());
    }
